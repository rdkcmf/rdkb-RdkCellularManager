    ...
    )
{
    ...
    {
        CcspTraceError((" !!! CellularMgr_MessageBus_Init: component_id or path is NULL !!!\n"));
    }
    ...
    /* Base interface implementation that will only be used by CellularManager */
    cb.initialize             = CellularMgr_Mbi_Initialize;
    cb.finalize               = CellularMgr_Mbi_Finalize;
    cb.freeResources          = CellularMgr_Mbi_FreeResources;
    cb.busCheck               = CellularMgr_Mbi_BusCheck;
